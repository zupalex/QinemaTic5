...
int main(int argc, char *argv[])
{
	...
	QObject::connect(&mainWindow, SIGNAL(RequestUpdateReac ( string, string, string, string, string, string, string, string, string, string, bool, bool )), calcM,
			SLOT(UpdateReacInfo ( string, string, string, string, string, string, string, string, string, string, bool, bool )));
	...
	QObject::connect(&mainWindow, SIGNAL(RequestPlotGraph ( vector<int>,string,string,string,string,string )), calcM,
			SLOT(PlotKinematicsGraph ( vector<int>,string,string,string,string,string )));
	...
	QObject::connect(calcM, SIGNAL(RequestFillReacInfoFields ( string,string,string,string,string,string,double,bool )), &mainWindow,
			SLOT(FillReacInfoFields ( string,string,string,string,string,string,double,bool )));
	...
	QObject::connect(calcM, SIGNAL(RequestEnableSecondSolution ( bool )), &mainWindow, SLOT(EnableSecondSolution ( bool )));

	QObject::connect(calcM, SIGNAL(RedrawPlotWidget ( string )), &mainWindow, SLOT(RedrawPlotWidget ( string )));

	QObject::connect(calcM, SIGNAL(AddGraph ( string,vector<double>,vector<double>,double,double,string,string,bool )), &mainWindow,
